...
const Footer = () => {
  return (
    <div className="fixed bottom-0 w-full bg-gradient-to-r from-white to-gray-100">
    <footer className="text-gray-600 body-font container mx-auto">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2024 EdgeNix —
            <a href="" className="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@twitter</a>
            </p>
